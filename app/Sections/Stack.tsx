...
const Stack = () => {
  ...
  return (
    <div className="relative w-full overflow-hidden">
      <div 
        className="absolute inset-0 w-full h-[calc(100%+8rem)] md:h-[calc(100%+16rem)]" 
        style={{
      ...
      <div className="w-full h-auto flex justify-center bg-transparent pt-8 pb-32 md:pb-64">
        <div className="w-full h-auto max-w-screen-xl flex flex-col px-4 relative">
          <div className="flex flex-col items-center px-5 text-5xl text-white">
            ...
            <div className="relative w-full h-[310px] flex items-center justify-center">
              <div className="absolute left-1/2 -translate-x-1/2 w-[980px] h-full flex flex-col justify-center">
