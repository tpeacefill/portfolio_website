      ...
      <div className="w-full h-auto max-w-screen-xl flex flex-col px-4 relative z-10">
        ...
        <div className="hidden lg:flex flex-col items-center justify-between mt-24 w-full lg:flex-row mb-56">
          ...
          <div className="relative flex flex-col items-center justify-center w-full lg:h-0.5">
            ...
            <m.div 
              className="absolute w-[26px] h-[26px] bg-[#8a74ff] rounded-full lg:left-[20%] flex items-center justify-center lg:-translate-x-1/2"
              initial={{ scale: 0, opacity: 0 }}
              whileInView={{ scale: 1, opacity: 1 }}
              transition={{ duration: 0.5, delay: 0.3 }}
            >
              <m.div 
                className="absolute w-0.5 h-[70px] bg-[#8a74ff] lg:bottom-[-70px]"
                initial={{ scaleY: 0 }}
                whileInView={{ scaleY: 1 }}
                transition={{ duration: 0.3, delay: 0.5 }}
              />
              <m.p 
                className="text-white text-opacity-50 text-[20px] font-Poppins font-thin lg:absolute lg:top-[100px] -ml-0 whitespace-nowrap"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            <m.div 
              className="absolute w-[26px] h-[26px] bg-[#8a74ff] rounded-full lg:left-[50%] flex items-center justify-center lg:-translate-x-1/2"
              initial={{ scale: 0, opacity: 0 }}
              whileInView={{ scale: 1, opacity: 1 }}
              transition={{ duration: 0.5, delay: 0.6 }}
            >
              <m.div 
                className="absolute w-0.5 h-[70px] bg-[#8a74ff] lg:top-[-70px]"
                initial={{ scaleY: 0 }}
                whileInView={{ scaleY: 1 }}
                transition={{ duration: 0.3, delay: 0.8 }}
              />
              <m.p 
                className="text-white text-opacity-50 text-[20px] font-Poppins font-thin lg:absolute lg:bottom-[100px] -ml-0 whitespace-nowrap"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
            ...
            <m.div 
              className="absolute w-[26px] h-[26px] bg-[#8a74ff] rounded-full lg:left-[80%] flex items-center justify-center lg:-translate-x-1/2"
              initial={{ scale: 0, opacity: 0 }}
              whileInView={{ scale: 1, opacity: 1 }}
            ...
            >
              ...
              />
              <m.p 
                className="text-white text-opacity-50 text-[20px] font-Poppins font-thin lg:absolute lg:top-[100px] -ml-1 whitespace-nowrap"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
